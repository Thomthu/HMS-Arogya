        ...
        <div class="col-75">
          <div class="container1">
            <form action="users.php" method="POST">
                <div class="heading"><h3>Users<img src="https://img.icons8.com/color/48/undefined/group.png"/></h3></div>
                
              <div class="row">
                  <div class="col-50">
                  <label for="email"> User id</label>
                  <input type="text" id="email" name="u_id" placeholder="Enter your id">
                  <label for="fname">User name</label>
                  <input type="text" id="fname" name="u_name" placeholder="Enter your name">
                ...
                <div class="col-50">
                    ...
                    <div class="col-50">
                        ...
                        <input type="text" id="fname" name="pwd" placeholder="contact number" >
            ...
            <?php  
              //insert query
                 if(isset($_POST['submit']))
                 {
                    ...
                    if($user_id!="" &&$user_name!="" &&$email!="" &&$password!="" &&$tp_number!="" )
                    {
                    $sql="INSERT INTO users(user_id,user_name,email,password,tp_number) VALUES('$user_id','$user_name',' $email','$password','$tp_number')";
                    if($con->query($sql))
                    {
                        echo "<script>alert('You Have Successfully Add The Users Record');</script>";
                    }
                    else
                    {
             ...
             <?php
                        ...
                        if(isset($_POST['delete']))
                        {
                            if($_POST['u_id']!=null)
                            {
                                ...
                                if($con->query($sql))
                                {
                                    echo "<script>alert('You Have Successfully Deleted The Users Record');</script>";
                                }
                                else
                                {
                 ...
                 {  
                    ...
                    if($user_id!="" &&$user_name!="" &&$email!="" &&$password!="" &&$tp_number!="" )
                    {
                    $sql="UPDATE users SET user_name='$user_name',email='$email',password='$password',tp_number='$tp_number' WHERE user_id='$user_id'";
                    if($con->query($sql))
                    {
                        echo"<script>alert('You Have Successfully Updated The Users Record');</script>";
                    }
                    else
                    {
        ...
        <div class="apptable">
          <table class="table" border="2">
              ...
              <?php
                  ...
                  $result=mysqli_query($con,"SELECT * FROM users");  //input table name
